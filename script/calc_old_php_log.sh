...
for hour in $(seq -f "%02g" 0 23); do
  ...
  bin/spark-submit --master local[4] /mnt/party-stat/target/old-log-jar-with-dependencies.jar \
    "/tmp/request-20200214$hour.gz" "/tmp/data3/20200214$hour.txt"
...
for hour in $(seq -f "%02g" 0 05); do
  ...
  cd /mnt/spark-3.0.0-preview2-bin-hadoop2.7
  bin/spark-submit --master local[4] /mnt/party-stat/target/old-log-jar-with-dependencies.jar \
    "/tmp/request-20200215$hour.gz" "/tmp/data3/20200215$hour.txt"
